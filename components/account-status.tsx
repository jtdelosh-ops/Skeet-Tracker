...
export function AccountStatus() {
  ...
  const [importLink,setImportLink]=useState('/imports');
  useEffect(()=>{setImportLink('/imports'+window.location.search);},[path]);
  ...
  return <section aria-label="Your account" style={{padding:"12px 20px",borderBottom:"1px solid #ccc",fontSize:14}}>
    <a href={importLink} style={{display:'inline-block',textDecoration:'underline',marginBottom:8}}>Import existing records</a>
