...
export function AccountStatus() {
  ...
  return <section aria-label="Your account" style={{padding:"12px 20px",borderBottom:"1px solid #ccc",fontSize:14}}>
    {profile&&<p>Signed in as <strong>{profile.displayName}</strong> · {profile.email}{profile.role==="admin"?<> · Administrator · <a href="/invitations" style={{textDecoration:"underline"}}>Manage invitations</a></>:""}</p>}
